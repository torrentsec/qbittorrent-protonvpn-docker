...
2. Username: **admin**
3. Password: **[the temporary password from above]**
...
3. Find "**Bypass authentication for clients on localhost**"
4. ✅ **CHECK THIS BOX** (enable it)
5. Click "**Save**"
...
2. Edit qBittorrent config:
   ...
   ```
3. Find or add these lines under `[Preferences]`:
   ```ini
   WebUI\HostHeaderValidation=false
   WebUI\CSRFProtection=false
   ```
4. Save and restart: `make up`
...
5. **If still failing, add skip flag (temporary):**
